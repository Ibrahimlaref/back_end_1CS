...
from apps.membersNsubscription.api.v1.views.subscription import (
...
urlpatterns = [
    ...
    # ── Subscribe to Plan ────────────────────────────────────────────────────
    path('gyms/<uuid:gym_id>/subscriptions/',
         SubscriptionCreateView.as_view(), name='subscription-create'),
    path('gyms/<uuid:gym_id>/subscriptions/<uuid:subscription_id>/confirm/',
